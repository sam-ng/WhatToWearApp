...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whatToWear = (Button)findViewById(R.id.whatToWear);
        ...
        whatToWear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, WhatToWearActivity.class);
                intent.putExtra("currentTemperature", currentTemperatureField.getText());
