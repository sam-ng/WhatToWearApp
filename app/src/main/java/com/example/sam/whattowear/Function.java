...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?lat=40.730610&lon=-73.935242";
    private static final String OPEN_WEATHER_MAP_API = "fa52f671e65f1955421365f20ce80349";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String temperature = String.format("%.2f", (main.getDouble("temp") -273)*(9.0/5)+32)+ "°";
